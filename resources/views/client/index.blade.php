          ...
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg3.jpg') }}" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                <img src="{{ asset('bower_components/assets-client/images/bg/bg3.jpg') }}"  alt=""  data-bgposition="center 10%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg2.jpg') }}" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="{{ asset('bower_components/assets-client/images/bg/bg2.jpg') }}"  alt=""  data-bgposition="center 40%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg4.jpg') }}" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                <img src="{{ asset('bower_components/assets-client/images/bg/bg4.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
            ...
            <div class="col-md-6">
              <div class="video-popup">                
                <a href="https://www.youtube.com/watch?v=pW1uVUg5wXM" data-lightbox-gallery="youtube-video" title="Video">
                  <img alt="" src="{{ asset('bower_components/assets-client/images/about/5.jpg') }}" class="img-responsive img-fullwidth">
                </a>
              </div>
            </div>
          </div>
              ...
              <div class="owl-carousel-4col" data-dots="true">
                <div class="col-md-4 col-sm-4 ">
                  <div class="service-block bg-white">
                    <div class="thumb"> <img alt="featured project" src="{{ asset('bower_components/assets-client/images/project/4.jpg') }}" class="img-fullwidth">
                ...
                <div class="col-md-4 col-sm-4">
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="{{ asset('bower_components/assets-client/images/project/5.jpg') }}" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                ...
                <div class="col-md-4 col-sm-4">
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="{{ asset('bower_components/assets-client/images/project/6.jpg') }}" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                ...
                <div class="col-md-4 col-sm-4">
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="{{ asset('bower_components/assets-client/images/project/7.jpg') }}" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                ...
                <div class="col-md-4 col-sm-4">
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="{{ asset('bower_components/assets-client/images/project/8.jpg') }}" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
          ...
          <div class="row multi-row-clearfix">
            <div class="col-sm-6 col-md-3 sm-text-center mb-sm-30">
              <div class="team maxwidth400">
                <div class="thumb"><img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/team/team5.jpg') }}" alt=""></div>
            ...
            <div class="col-sm-6 col-md-3 sm-text-center mb-sm-30">
              <div class="team maxwidth400">
                <div class="thumb"><img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/team/team6.jpg') }}" alt=""></div>
                <div class="content border-1px border-bottom-theme-color-2-2px p-15 bg-light clearfix">
            ...
            <div class="col-sm-6 col-md-3 sm-text-center mb-sm-30">
              <div class="team maxwidth400">
                <div class="thumb"><img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/team/team7.jpg') }}" alt=""></div>
                <div class="content border-1px border-bottom-theme-color-2-2px p-15 bg-light clearfix">
            ...
            <div class="col-sm-6 col-md-3 sm-text-center">
              <div class="team maxwidth400">
                <div class="thumb"><img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/team/team8.jpg') }}" alt=""></div>
                <div class="content border-1px border-bottom-theme-color-2-2px p-15 bg-light clearfix">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div id="grid" class="gallery-isotope grid-4 gutter clearfix">
                ...
                <div class="gallery-item select1 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s1.jpg') }}" alt="project">
                ...
                <div class="gallery-item select1 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s2.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <!-- Portfolio Item Start -->
                <div class="gallery-item select2 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s3.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <!-- Portfolio Item Start -->
                <div class="gallery-item select3 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s4.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select1 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s5.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select3 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s6.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select2 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s7.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select3 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s8.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select1 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s9.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select2 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s10.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select1 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s11.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item select3 col-md-4 col-sm-4">
                  <div class="thumb">
                    <img class="img-fullwidth" src="{{ asset('bower_components/assets-client/images/gallery/s12.jpg') }}" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb mr-20"><img alt="" src="{{ asset('bower_components/assets-client/images/event/1.jpg') }}"></a>
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb mr-20"><img alt="" src="{{ asset('bower_components/assets-client/images/event/2.jpg') }}"></a>
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="#">Upcoming Event Title</a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2016 |</li>
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb mr-20"><img alt="" src="{{ asset('bower_components/assets-client/images/event/3.jpg') }}"></a>
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="#">Upcoming Event Title</a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2016 |</li>
          ...
          <div class="col-md-12 mb-10">
            <div class="owl-carousel-2col boxed" data-dots="true">
              <div class="item">
                <div class="testimonial pt-10">
                  <div class="thumb pull-left mb-0 mr-0 pr-20">
                    <img width="75" class="img-circle" alt="" src="{{ asset('bower_components/assets-client/images/testimonials/1.jpg') }}">
                  </div>
                  <div class="ml-100 ">
              ...
              <div class="item">
                <div class="testimonial pt-10">
                  <div class="thumb pull-left mb-0 mr-0 pr-20">
                    <img width="75" class="img-circle" alt="" src="{{ asset('bower_components/assets-client/images/testimonials/2.jpg') }}">
                  </div>
                  <div class="ml-100 ">
                    <h4 class="text-white mt-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas vel sint, ut. Quisquam doloremque minus possimus eligendi dolore ad.</h4>
                    <p class="author mt-20">- <span class="text-theme-color-2">Catherine Grace,</span> <small><em class="text-gray-lightgray">CEO apple.inc</em></small></p>
              ...
              <div class="item">
                <div class="testimonial pt-10">
                  <div class="thumb pull-left mb-0 mr-0 pr-20">
                    <img width="75" class="img-circle" alt="" src="{{ asset('bower_components/assets-client/images/testimonials/3.jpg') }}">
                  </div>
                  <div class="ml-100 ">
                    <h4 class="text-white mt-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas vel sint, ut. Quisquam doloremque minus possimus eligendi dolore ad.</h4>
                    <p class="author mt-20">- <span class="text-theme-color-2">Catherine Grace,</span> <small><em class="text-gray-lightgray">CEO apple.inc</em></small></p>
          ...
          <div class="row">
              ...
              <article class="post clearfix mb-sm-30">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="{{ asset('bower_components/assets-client/images/blog/7.jpg') }}" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
              <article class="post clearfix mb-sm-30">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="{{ asset('bower_components/assets-client/images/blog/2.jpg') }}" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                <div class="entry-content p-20 pr-10 bg-white">
                  <div class="entry-meta media mt-0 no-bg no-border">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
              <article class="post clearfix">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="{{ asset('bower_components/assets-client/images/blog/5.jpg') }}" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                <div class="entry-content p-20 pr-10 bg-white">
                  <div class="entry-meta media mt-0 no-bg no-border">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="owl-carousel-6col clients-logo transparent text-center owl-nav-top">
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w1.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w2.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w3.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w4.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w5.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w6.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w3.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w4.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w5.png" alt=""></a></div>
              <div class="item"> <a href="#"><img src="{{ asset('bower_components/assets-client/images/clients/w6.png" alt=""></a></div>
