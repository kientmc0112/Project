                        ...
                        <div class="col-md-12">
                            <div>
                                <ul>
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Assign User</button>
                                </ul>
                            </div>
                        ...
                        <table class="table table-bordered" style="margin-top:20px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form id="finish-form" action="{{ route('finishCourse', $userDetail->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                            @foreach ($userCourseDetail as $user)
...
{{-- ------------------------------------------------------------------------------------------- --}}
                                ...
                                <tr class="table-active">
                                    ...
                                    <td>
                                        <form id="finish-form" action="{{ route('finishSubject', $userDetail->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                            @foreach ($userSubjectDetail as $user)
    ...
    {{-- ------------------------------------------------------------------------------- --}}
                                ...
                                <tr class="table table-info">
                                    ...
                                    <td>
                                        <form id="finish-form" action="{{ route('finishTask', $userDetail->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                            @foreach ($userTaskDetail as $user)
