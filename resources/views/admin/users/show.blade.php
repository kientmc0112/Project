                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tbcourses">COURSES</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tbsubjects">SUBJECTS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tbtasks">TASKS</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div id="tbcourses" class="container tab-pane active"><br>
                                ...
                                <div id="tbsubjects" class="container tab-pane fade"><br>
                                    <table class="table table-bordered" style="margin-top:20px;">
                                        <thead>
                                            <tr class="bg-primary">
                                                <th>{{ trans('setting.id') }}</th>
                                ...
                                <div id="tbtasks" class="container tab-pane fade">
                                    <table class="table table-bordered" style="margin-top:20px;">
                                        <thead>
                                            <tr class="bg-primary">
                                                <th>{{ trans('setting.id') }}</th>
